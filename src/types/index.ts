...
export type PermissionKey = 'dashboard' | 'crews' | 'employees' | 'users' | 'attendance' | 'dailyReports' | 'statistics' | 'permissions' | 'settings' | 'dailyReports.notify' | 'dailyReports.addManual' | 'dailyReports.moveEmployee';
